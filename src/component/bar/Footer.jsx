			...
			<div id="Footer">
				<div className="Footer-content">
					<div className="Footer-contact">
						...
						<div>
							<a href="mailto:info@cybersecurity.lu">info@cybersecurity.lu</a>
						</div>
						<br/>
					...
					<div className="Footer-links">
						...
						<div className="Footer-documentation-and-terms">
							<a
								...
								title="Terms of use"
								className="text-capitalize">
								<i className="fa fa-file-text"/> Terms of Service
							</a>
						</div>
						<div>
							<a
								...
								title="Terms of use"
								className="text-capitalize">
								<i className="fa fa-file-text"/> CSWL Data Protection Notice
							</a>
						</div>
					</div>
				</div>
